...
import { ImageBackground, Dimensions, StyleSheet, Keyboard, Modal, TextInput, ActivityIndicator } from 'react-native'
                    ...
                    (value)=>{
                        ...
                        if(this.state.modalBio == "" || this.state.modalOccupation == ""){
                            ...
                            axios.post("/user/profile/update", {
                                ...
                                Occupation: this.state.modalOccupation
                            }).then((response)=>{
    ...
    render() {
        return (
            <Background {...this.props} title="Profile" searchBar={false} contentRender={(props)=> (
                ...
                (this.props.showDifferentUser) ?  <View style={{alignItems: 'center', flex: 1, margin: 15}}>
                                                        ...
                                                        <Text style={{
                                                            ...
                                                            <View style={{
                                                                ...
                                                                <View style={{justifyContent: 'center', alignItems: 'center', margin: 15}}>
                                                                    ...
                                                                    </TouchableOpacity>:<View style={{justifyContent:'center', alignItems: "center", margin: 15}}>
